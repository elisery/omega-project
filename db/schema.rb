...
ActiveRecord::Schema.define(version: 2018_07_28_191125) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.string "event_url"
    t.string "time"
    t.bigint "meetup_group_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["meetup_group_id"], name: "index_events_on_meetup_group_id"
  end
  ...
  add_foreign_key "events", "meetup_groups"
